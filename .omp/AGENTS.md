...
При масштабных изменениях (новые пакеты, смена архитектуры, зависимости) — обнови этот файл. Задача: следующий агент должен войти в проект без чтения всей кодовой базы.
